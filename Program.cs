    ...
    class Program{
        ...
        static void InstrucaoIf(string[] args){
            if (args.Length == 0){
                ...
                //O $ "String Interpolation", significa uma interpolação de string, ou seja, uma concatenação com o texto da string.
        ...
        static void InstrucoesTryCatchFinallyThow(string[] args){
